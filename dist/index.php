<!DOCTYPE html><html lang="en"><!--HEAD--><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>Coloring Book</title><link rel="stylesheet" href="dist/css/main.css" type="text/css"></head><!--BODY--><body><header id="top"><div id="logo"><a href="index.php"><img id="logo" src="graphics/logo.png"></a></div></header><h1>User Created</h1><div class="image-grid user-created"> <?php
        ...
        ?> <a href="index.php?all-uc" class="thumbnails"><div id="show-all">View All User Created</div></a></div> <?php if (!isset($_GET['all-uc'])) { ?> <h1>Templates</h1><div class="image-grid"> <?php
