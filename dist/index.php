<!DOCTYPE html><html lang="en"><!--HEAD--><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>Coloring Book</title><link rel="stylesheet" href="dist/css/normalize.css" type="text/css"><link rel="stylesheet" href="dist/css/main.css" type="text/css"></head><!--BODY--><body><header id="top"><img src="graphics/logo.png" id="logo"></header><h1>User Created</h1><div class="image-grid user-created"> <?php
        ...
        ?> </div><h1>Templates</h1><div class="image-grid"> <?php
            include_once 'includes/db.php';
        ...
        ?> </div><footer><a class="back-to-top" href="#top"><img class="b2t" src="graphics/b2t.svg" alt="back to top"></a></footer></body></html>